                        ...
                        <div class="card-body">
                            ...
                            <form id="checkout-form" method="POST" action="{{ route('order.store') }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select form-select-lg" id="delivery_time" name="delivery_time"
                                        required>
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                                    ...
                                    <div class="row align-items-center py-2 border-bottom">
                                        ...
                                        <div class="col-4 text-end">
                                            <span class="text-danger fw-bold">¥
                                                {{ number_format($item->line_total) }}</span>
                                        </div>
                                    </div>
                                @endforeach
                            @else
                                <div class="row py-3">
                                    <div class="col-12 text-center text-muted">
                                        ...
                                        <a href="{{ route('products.index') }}" class="btn btn-primary">Tiếp tục mua
                                            sắm</a>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="row py-2 border-bottom">
                                ...
                                <div class="col-4 text-end">
                                    <span class="text-danger fw-bold"
                                        id="subtotal">{{ $orderSummary['formatted_subtotal'] }}</span>
                                </div>
                            </div>
                            ...
                            <div class="row py-2 border-bottom">
                                ...
                                <div class="col-4 text-end">
                                    <span class="text-danger fw-bold"
                                        id="shipping-fee">{{ $orderSummary['formatted_shipping_fee'] }}</span>
                                </div>
                            </div>
                            ...
                            @if ($orderSummary['processing_fee'] > 0)
                                <div class="row py-2 border-bottom">
                                    ...
                                    <div class="col-4 text-end">
                                        <span class="text-danger fw-bold"
                                            id="processing-fee">{{ $orderSummary['formatted_processing_fee'] }}</span>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="row py-3 border-bottom">
                                ...
                                <div class="col-4 text-end">
                                    <span class="text-danger fw-bold fs-5"
                                        id="total-amount">{{ $orderSummary['formatted_total'] }}</span>
                                </div>
                            </div>
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            ...
                            if (shippingInfoElement && data.zone_name && data.delivery_days) {
                                shippingInfoElement.textContent =
                                    `${data.zone_name} - ${data.delivery_days} ngày`;
                            }
                            ...
                            if (shippingInfoElement) {
                                shippingInfoElement.textContent = data.message ||
                                    'Không hỗ trợ giao hàng đến khu vực này';
                            }
                            updateTotal(0);
                        }
                    })
