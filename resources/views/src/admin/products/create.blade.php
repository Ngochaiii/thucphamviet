                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('jp_name') is-invalid @enderror"
                                        id="jp_name" name="jp_name" value="{{ old('jp_name') }}">
                                    @error('jp_name')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('specification') is-invalid @enderror" id="specification"
                                        name="specification" rows="5">{{ old('specification') }}</textarea>
                                    @error('specification')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4 @error('currency') is-invalid @enderror"
                                                ...
                                                @foreach ($currencies as $code => $name)
                                                    <option value="{{ $code }}"
                                                        {{ old('currency', 'JPY') == $code ? 'selected' : '' }}
                                ...
                                <div class="alert alert-info" id="price-preview">
                                    <strong>Giá hiển thị:</strong> <span id="formatted-price">¥0</span>
                                </div>
                            </div>
                        </div>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="images">Hình ảnh phụ (nhiều ảnh)</label>
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file"
